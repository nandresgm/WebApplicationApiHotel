...
namespace WebApplicationApiHotel.Controllers.TipoDocumentos
{
    [Route("api/[controller]/[action]")]
    [ApiController]
    public class TipoDocumentoesController : ControllerBase
    {
        private readonly WebApplicationApiHotelContextTipoDocumentos _context;

        public TipoDocumentoesController(WebApplicationApiHotelContextTipoDocumentos context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TipoDocumento>> PostTipoDocumento(TipoDocumento tipoDocumento)
        {
          if (_context.TipoDocumento == null)
          {
              return Problem("Entity set 'WebApplicationApiHotelContextTipoDocumentos.TipoDocumento'  is null.");
          }
